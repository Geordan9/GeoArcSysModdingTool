...
namespace GeoArcSysModdingTool
{
    internal class CustomSettingsProvider : SettingsProvider
    {
        ...
        /// </summary>
        private string UserConfigPath => Settings.Default.SettingsKey;
        ...
        private void LoadValuesFromFile()
        {
            ...
            var settingElements = configXml.Element(CONFIG).Element(USER_SETTINGS).Element(typeof(Settings).FullName)
                .Elements(SETTING);
